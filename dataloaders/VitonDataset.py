...
semantic_densepose_labels = [
	...
	[20, 80, 194], #torso
	[4, 97, 223], #left hand
	[8, 110, 221], #right hand
	[6, 166, 198], #left leg
	[22, 173, 185], #right leg
	[145, 191, 116], #R(upper arm left)
	[170, 189, 105], #L(upper arm right)
	[192, 188, 96], #R(upper arm right)
	[216, 186, 86], #L(upper arm left)
	[228, 192, 74], #R(lower arm left)
	[240, 199, 60], #L(lower arm right)
	[252, 206, 46], #R(lower arm right)
	[251, 220, 36], #L(lower arm left)
	[250, 235, 25], #head left
	[249, 251, 14] # head right
]
